...
* Управление данными о городах (добавление новые города и информации о них, изменение и удаление любой информации) производится посредством REST WebService. 
